...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("RelaxingGame", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("RelaxingGame", null, 800, 800);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "RelaxingGame";
		app.meta["name"] = "RelaxingGame";
